...
function Card({username,designation, rating, followers, offconnnection, btnText}) {

    console.log("xxx",username,designation, rating, followers, offconnnection, btnText);
    return (
        <>
